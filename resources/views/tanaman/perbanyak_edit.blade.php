                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tab-tambah-edit" data-toggle="pill"
                                        ...
                                        aria-selected="false">Edit Perbanyak</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                <div class="tab-pane active" id="tab-tambah-edit" role="tabpanel"
                                    ...
                                    <form action="{{ route('perbanyak.update',$perbanyak->ID)}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama</label>
                                            <input type="hidden" value="{{ $perbanyak->ID}}" name="idperbanyak">
                                            <input type="text" class="form-control"  name="nama"
                                                placeholder="Masukkan Nama Perbanyak" value="{{ $perbanyak->NAMA }}" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="submit" name="proses" id="proses" value="Update"
                                                class="btn btn-primary">
                                                <a href="{{ route('perbanyak.index')}}" class="btn btn-warning" style="display: inline">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
